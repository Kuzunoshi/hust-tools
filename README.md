...
| 4 | **Location** | 地图关键词模糊定位 | `python main.py`（需高德 API Key） |
| 5 | **Lrc_match** | 歌词修复/格式转换/乱码修复 | `python main.py` |
...
> **Gal_Extractor 已迁出** → [M1zukiri/Gal-Extractor](https://github.com/M1zukiri/Gal-Extractor)
> 原 .NET 项目已独立为单独仓库，继续在那边推进开发。
